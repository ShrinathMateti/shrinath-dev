...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    setStatus(""); // ← clear previous status on each new submit

    try {
      const response = await fetch("https://formspree.io/f/xwvybyyz", {
        method: "POST",
    ...
    <section className="bg-slate-900 text-white py-20 mt-12" id="contact">
      <div className="container mx-auto px-6 md:px-16 lg:px-24 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="p-5">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <a
                  href="mailto:shrinathrmateti@gmail.com"
          ...
          {/* Right Side Form */}
          <div>
            {status && <p className="text-center mb-4 font-medium">{status}</p>}
